...
function main() {
  ...
  const NEXTJS_TARGET_DIR = process.argv.slice(2)[0];

  // Ensure target directories exist
  if (!NEXTJS_TARGET_DIR) {
    console.log(`Please specify the path for genrerated contracts for Next.js using NEXTJS_TARGET_DIR environment variable...`);
    return;
  }
